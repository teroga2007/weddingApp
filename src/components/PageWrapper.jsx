      ...
      <main className="flex-grow container mx-auto p-6 md:px-12 bg-accent-100">
        {title && (
          <div className="relative my-20 text-center">
            <h2 className="pb-3 absolute inset-0 text-3xl md:text-8xl font-black font-sans opacity-5 pointer-events-none select-none flex items-center justify-center">
              {titleBack}
            </h2>
